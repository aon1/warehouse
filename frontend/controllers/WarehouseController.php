...
class WarehouseController extends Controller
{
    ...
    {
        echo Json::encode(Warehouse::find()->asArray()->all());
    }
    ...
    public function actionList() {
        ...
        if (isset($_POST['depdrop_parents'])) {
            ...
            if ($parents != null) {
                $warehouse_current_id = $parents[0];
                $out = Warehouse::find()->
                    select(['warehouse_id as id', 'label as name'])->
                    andWhere('warehouse_id != ' . $warehouse_current_id)->
                    asArray()->all();
